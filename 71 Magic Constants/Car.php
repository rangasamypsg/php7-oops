<?php
namespace MagicConstants\Vehicles\Cars;

require_once('Vehicle.php');
require_once('Engine.php');
require_once('Transmission.php');

class Car extends \MagicConstants\Vehicles\Vehicle
{
    use \MagicConstants\Vehicles\Cars\CarParts\Transmission, \MagicConstants\Vehicles\Cars\CarParts\Engine {
        \MagicConstants\Vehicles\Cars\CarParts\Transmission::check_oil_level insteadof \MagicConstants\Vehicles\Cars\CarParts\Engine;
        \MagicConstants\Vehicles\Cars\CarParts\Engine::check_oil_level as check_engine_oil_level;
    }
